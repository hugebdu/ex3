...
import idc.cgeom.ex3.VisibilityLineOfSightHelper;
...
public class GreedySolution implements Solution
{
    ...
    {
        AdjacencyMatrix adjacencyMatrix = new DefaultAdjacencyMatrix(guards, diamonds, 
                new VisibilityLineOfSightHelper(triangulation));
